...
private:
	...
	void createImage(uint32_t width, uint32_t height, int32_t mipLevels, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties,
